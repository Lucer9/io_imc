...
class _PantallaIMCState extends State<PantallaIMCStateful> {
  ...
  Widget build(BuildContext context) {
    ...
    setState(() {
      ...
      if(IMC < 18.5){
        _IMCModelo = IMCModelo(imc: IMC, esNormal: false, resultado: "Estás flaquito");
      }else if(IMC < 24.9){
        _IMCModelo = IMCModelo(imc: IMC, esNormal: true, resultado: "Tas bien");
      }else if(IMC > 24.9){
        _IMCModelo = IMCModelo(imc: IMC, esNormal: false, resultado: "tas bordo");
      }else{
        _IMCModelo = IMCModelo(imc: IMC, esNormal: false, resultado: "hay un error");
      }
    });
